...
calendario = {
    "05/01/2025": ("1º Domingo após Epifania", "epifania"),
    "12/01/2025": ("2º Domingo após Epifania", "epifania"),
    "19/01/2025": ("3º Domingo após Epifania", "epifania"),
    "26/01/2025": ("4º Domingo após Epifania", "epifania"),
    "02/02/2025": ("5º Domingo após Epifania", "epifania"),
    "09/02/2025": ("6º Domingo após Epifania", "epifania"),
    "16/02/2025": ("7º Domingo após Epifania", "epifania"),
    "23/02/2025": ("8º Domingo após Epifania", "epifania"),

    "02/03/2025": ("1º Domingo da Quaresma", "quaresma"),
    "09/03/2025": ("2º Domingo da Quaresma", "quaresma"),
    "16/03/2025": ("3º Domingo da Quaresma", "quaresma"),
    "23/03/2025": ("4º Domingo da Quaresma", "quaresma"),
    "30/03/2025": ("5º Domingo da Quaresma", "quaresma"),
    "06/04/2025": ("Domingo da Paixão", "quaresma"),
    "13/04/2025": ("Domingo de Ramos", "quaresma"),

    "20/04/2025": ("Domingo da Ressurreição", "pascoa"),
    "27/04/2025": ("2º Domingo da Páscoa", "pascoa"),
    "04/05/2025": ("3º Domingo da Páscoa", "pascoa"),
    "11/05/2025": ("4º Domingo da Páscoa", "pascoa"),
    "18/05/2025": ("5º Domingo da Páscoa", "pascoa"),
    "25/05/2025": ("6º Domingo da Páscoa", "pascoa"),
    "01/06/2025": ("7º Domingo da Páscoa", "pascoa"),

    "08/06/2025": ("Pentecostes", "pentecostes"),
    ...
    "26/10/2025": ("16º Domingo após Pentecostes", "tempo-comum"),
    ...
    "23/11/2025": ("20º Domingo após Pentecostes", "tempo-comum"),

    "30/11/2025": ("1º Domingo do Advento", "advento"),
    "07/12/2025": ("2º Domingo do Advento", "advento"),
    "14/12/2025": ("3º Domingo do Advento", "advento"),
    "21/12/2025": ("4º Domingo do Advento", "advento"),
    "25/12/2025": ("Natal do Senhor", "natal"),
